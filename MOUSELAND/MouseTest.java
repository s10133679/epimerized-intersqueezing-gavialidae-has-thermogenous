...
public class MouseTest extends TestCase {
	...
	public void setUp(){
		...
		testNormal2 = new Mouse(15,20,Direction.LEFT,1);
		testNormal3 = new Mouse(50,50,Direction.LEFT,1);
		testZero = new Mouse(0,0,Direction.LEFT,2);
		testNegative = new Mouse(-5,-10,Direction.LEFT,3);
		testHuge = new Mouse(5000,10000,Direction.LEFT,4);
