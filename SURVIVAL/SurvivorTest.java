...
public class SurvivorTest extends TestCase {
	Survivor testNormal, testNormal2,testNormal3, testZero, testNegative, testHuge;
	Image testImage;
	SurvivalMap map;
	SurvivalGame game;
	
	public void setUp(){
		testNormal = new Survivor(5,10,Direction.LEFT,1);
		testNormal2 = new Survivor(15,20,Direction.LEFT,1);
		testNormal3 = new Survivor(50,50,Direction.LEFT,1);
		testZero = new Survivor(0,0,Direction.LEFT,2);
		testNegative = new Survivor(-5,-10,Direction.LEFT,3);
		testHuge = new Survivor(5000,10000,Direction.LEFT,4);
		
		testImage = new ImageIcon("SURVIVAL/hero.png").getImage();
	...
	public void testOnEventDieToZombie() {
		...
		Survivor tempHero = new Survivor(8,9,Direction.LEFT,3);
